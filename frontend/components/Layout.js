            ...
            return (
              <Link key={item.href} href={item.href} legacyBehavior>
                <a
                  ...
                  aria-current={active ? 'page' : undefined}
                  style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3px', padding: '6px 0', textDecoration: 'none', color: active ? '#2563EB' : '#9CA3AF', transition: 'color 0.12s' }}
                >
                  {item.icon}
