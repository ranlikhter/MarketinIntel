...
const NAV = [
  ...
  {
    href: '/competitor-catalog',
    label: 'Product Catalog',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="5" rx="1" /><rect x="14" y="3" width="7" height="5" rx="1" /><rect x="3" y="12" width="7" height="5" rx="1" /><rect x="14" y="12" width="7" height="5" rx="1" /></svg>,
  },
  {
    href: '/insights',
    label: 'Intelligence',
  ...
  {
    href: '/category-defaults',
    label: 'Margin Defaults',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 00-6.32 17.79A10 10 0 0012 22a10 10 0 100-20zm0 0v20M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10" /><path d="M9 12l2 2 4-4" /></svg>,
  },
  {
    href: '/integrations',
    label: 'Integrations',
